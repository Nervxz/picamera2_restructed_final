#!/usr/bin/env python3
"""
Example: IMX500 Object Detection with Multiprocessing (Restructured)

This example demonstrates how to use the restructured picamera2 module
for IMX500 object detection with multiprocessing.

The restructured version maintains 100% compatibility with the original
while providing better code organization through modular architecture.
"""
...
# Device-specific modules remain from original picamera2
# (these are hardware-specific and don't need restructuring)
...
if __name__ == "__main__":
    ...
    # Initialize IMX500 device - this must be done before Picamera2 instantiation
    ...
    # Start detection drawing thread
    ...
    try:
        ...
        print("\nStopping...")
        jobs.put(None)  # Signal thread to exit
        thread.join()
        pool.close()
        pool.join()
        picam2.stop()
